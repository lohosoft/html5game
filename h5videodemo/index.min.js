...
function handleFileComplete(event) {
    ...
    if (event.item.src === globalData.startImgSrc) {
        ...
        globalData.sVideo.src = event.result.src;
        ...
        globalData.tVideo.src = event.result.src;
...
function handleFileProgress(event) {
    ...
    if (event.progress >= 1) {
        ...
        document.body.removeChild(globalData.progressP);
        myInit();
    };
